(() => {
	...
	const pageConfig = {
		...
		firefighter: {
			practiceHref: "practice_firefighter.html"
		},
		hazmat: {
			practiceHref: "practice_hazmat.html"
		},
		PDO: {
			practiceHref: "practice_pdo.html"
		}
	};
	...
	header.innerHTML = `
		...
		<h1>${titleText}</h1>
		<p class="header-subtitle">Fixed Length Practice Test</p>
	`;
